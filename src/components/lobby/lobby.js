                                        ...
                                        return <div key={lobby._id}>
                                            ...
                                            <div style={{ background: `linear-gradient(rgba(0,0,0,0.7),rgba(0,0,0,0.7)),url(${lobby.game === 'Chess' ? "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTiFoJYHvH8RZt_QkDQ_SirIaNqSz3X0T3Aeg&usqp=CAU" : "https://wallpapercave.com/wp/wp2532627.jpg"})`, backgroundPosition: 'center', backgroundSize: 'cover', marginBottom: '40px', border: '2px solid #ffba00' }} className="crumina-module crumina-event-item">
                                                ...
                                                <div className="event-content">
                                                    ...
                                                    <h4 className="event-title mb15">{lobby.timestamp - Date.now() >= 0 ? <DateCounter duration={lobby.timestamp - Date.now()}></DateCounter> : <>Countdown Completed.</>}</h4>
                                                ...
                                                <div className="event-venue">
                                                    ...
                                                    <div className="event-date">
                                                        ...
                                                        <h6><i className="fas fa-gamepad"></i>&nbsp;{lobby.game}</h6> &nbsp;{Date.now() >= lobby.timestamp ? <button className="btn btn--small btn--dark">Expired </button> : this.checkJoin(lobby.players) ? <button className="btn btn--small btn--green-light">Joined </button> : this.state.isJoining ? <button disabled={true} className="btn btn--small btn--green-light">Joining </button> : <button onClick={this.handleJoin.bind(this, lobby._id)} className="btn btn--small btn--green-light">Join </button>}
                                                    </div>
